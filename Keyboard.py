...
TitleLabel = Label(root, text='On Screen Keyboard', font=('arial', 28, 'bold'), fg='white', bg='gray30')
TitleLabel.grid(row=0, columnspan=40)

TextArea = Text(root, font=('arial', 14, 'bold'), height=10, width=100, wrap='word')
TextArea.grid(row=1, columnspan=200)
...
apostBtn = ttk.Button(keysframe, text='`', width=5)
apostBtn.grid(row=0, column=0)

tildBtn = ttk.Button(keysframe, text='~', width=5)
tildBtn.grid(row=0, column=0)
tildBtn.grid_remove()
...
buttonback = ttk.Button(keysframe, text='Back', width=5, )
